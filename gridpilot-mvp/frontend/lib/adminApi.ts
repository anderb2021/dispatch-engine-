...
/** Any authenticated Supabase user (participant or admin). */
...
export async function proxyUserGet<T>(path: string): Promise<AdminApiResult<T>> {
...
export async function proxyUserPost<T>(
  path: string,
